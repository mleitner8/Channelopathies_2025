...
def custom(UCDAVIS=False):
    params = specs.ODict()
    # # long-range inputs
    params[('weightLong', 'TPO')] = [0.6628841085342276, 0.6628841085342276] #[0.5] 0.5895149242323676
    params[('weightLong', 'TVL')] = [0.7072047473953170, 0.7072047473953170] #[0.5, 0.6804077462102610]
    params[('weightLong', 'S1')] = [0.7496724591024150, 0.7496724591024150] #[0.5] 0.7444698182880550
    params[('weightLong', 'S2')] = [0.39135186448323200, 0.39135186448323200] #[0.5] 0.3007340009078160 
    params[('weightLong', 'cM1')] = [0.7488867546364240, 0.7488867546364240] #[0.5] 0.7389012179852030
    params[('weightLong', 'M2')] = [0.747621856988085, 0.747621856988085] #[0.5] 0.7089613193927110
    params[('weightLong', 'OC')] = [0.7489766815681180, 0.7489766815681180] #[0.5] 0.7424614470282160

    # EEgain
    params['EEGain'] = [1.383548562018420, 0.7791891385564440] #0.7791891385564440]#[1.0]
    params['IPTGain'] = [1] #[0.8, 0.9, 1, 1.1, 1.2]
    ...
    # IEgain
    ## L2/3+4
    params[('IEweights',0)] = [0.8592967766239300, 0.7857336966286300] #0.7857336966286300] #[1.0]
    ## L5
    params[('IEweights',1)] = [1.4920159216976000, 1.327220527083950] #1.327220527083950] #[1.0]
    ## L6
    params[('IEweights',2)] = [1.281835118961600, 1.0278844998120800]#1.0278844998120800] #[1.0]

    # IIGain
    params['IIGain'] = [1.0]

    ## L2/3+4
    params[('IIweights', 0)] = [1.4254093053911300, 1.4259084458667200] #1.4259084458667200] #[1.0]
    ## L5
    params[('IIweights', 1)] = [0.6253423296011460, 1.290334288421050] #1.290334288421050] #[1.0]
    ## L6
    params[('IIweights', 2)] = [1.4879855139023765, 1.4889318189986225] #1.4889318189986225] #[1.0]
...
if __name__ == '__main__': 
    ...
    b = custom(UCDAVIS)
    if UCDAVIS:
        b.batchLabel = 'grid_M1_UCDavis_v1_tune2'
    else:
